...
const FOREMAN_VISION_DAILY_LIMITS = Object.freeze({ guest: 0, free: 1, consumer: 10, pro: 25 });
...
function visionLimitMessage(tier) {
  ...
  if (tier === "free") return "You’ve used today’s Account – Free photo analyses. Upgrade to DIY or Contractor for more photo-powered Foreman help.";
  if (tier === "consumer") return "You’ve reached today’s DIY photo analysis limit. Upgrade to Contractor for higher photo usage.";
  return "You’ve reached today’s Foreman Vision usage limit.";
}
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // 0 = unlimited for this tier. Only applies when the app sends a project_id.
