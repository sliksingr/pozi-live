...
// NOTE: this prompt is kept identical to the one in buildr-chat-stream.mjs. This file is
// the non-streaming fallback, so if the two drift the user gets different behaviour
// depending on which endpoint answered. Change both together.
