...
function foremanLimitMessage(tier) {
  ...
  if (tier === "free") return "You’ve used your free Foreman sessions for today. Upgrade to Consumer or Pro to keep building.";
  if (tier === "consumer") return "You’ve reached today’s Consumer Foreman session limit. Upgrade to Pro for higher project usage.";
...
function foremanMessageLimitMessage(tier) {
  ...
  if (tier === "consumer") return "You’ve reached the 10-message limit for this Consumer Foreman session. Start a new Foreman session if you have sessions remaining today.";
  if (tier === "pro") return "You’ve reached the 15-message limit for this Pro Foreman session. Start a new Foreman session if you have sessions remaining today.";
